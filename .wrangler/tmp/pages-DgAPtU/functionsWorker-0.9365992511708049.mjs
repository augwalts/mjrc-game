...
var isStr = /* @__PURE__ */ __name((v) => typeof v === "string" && v.length > 0, "isStr");
function invalid(m) {
...
var unauthorized = /* @__PURE__ */ __name((message, status = 401) => new Response(message, {
  status,
  headers: {
...
// ../.wrangler/tmp/pages-DgAPtU/functionsRoutes-0.5664426446886196.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-Ui7Fk4/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-Ui7Fk4/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9365992511708049.mjs.map
